        ...
        <div class=" w-full h-[80vh] lg:h-full relative " >
            ...
            <div ref="box1" class=" absolute inset-x-0 bottom-0 top-[50px] lg:top-[120px] z-10 lg:px-0 px-3 flex items-center justify-center " >
                <div class=" w-full lg:w-[85%] h-full flex pt-16 flex-col gap-4 text-white " >
                    ...
                    <p class=" font-bold text-4xl lg:text-[60px] max-w-[1000px] leading-[40px] lg:leading-[81px] " >Helping Small Businesses Stay HR Compliant with Ready-to-Use HR Templates & Consulting</p>
                    <p class=" max-w-[650px] lg:text-lg " >Simplify HR with expert guidance and downloadable HR solutions, saving you time, money, and compliance headaches.</p>
                    <NuxtLink to="/contactus">
                        <button class=" px-5 w-fit cursor-pointer border-t-[0.6px] lg:text-base text-xs border-l-[0.6px] border-[2px] rounded-[40px] h-[64px] border-white " >Book a Consultation</button>
                    </NuxtLink>
                </div>
            </div>
        </div>  
