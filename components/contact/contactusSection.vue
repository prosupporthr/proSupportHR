<template>
    <div class=" w-full flex justify-center lg:pb-20 px-3 " >   
        <div class=" w-full lg:w-[85%] py-12 flex flex-col items-center shadow-2xl rounded-2xl gap-4 " >  
            ...
            <!-- <button class=" w-[174px]  text-white font-semibold text-sm h-[50px] rounded-4xl bg-blue-bg " >Get in Touch</button> -->
        </div>
    </div>
</template>