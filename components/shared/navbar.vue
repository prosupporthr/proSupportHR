...
<template>
    <div :class=" atTopOfPage ? ' shadow-none ' : ' scrolled shadow-2xl ' " class=" navbar w-full max-w-screen overflow-hidden h-fit flex flex-col-reverse lg:flex-col z-50 justify-center items-center " >
