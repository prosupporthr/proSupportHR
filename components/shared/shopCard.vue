<template>
    <div class=" w-full rounded-2xl " >
        ...
        <div class=" p-4 w-full flex gap-4 flex-col border-t-0 border-[0.36px] border-border-color rounded-b-xl " >
            ...
            <p class=" text-primary-text text-xl font-bold " >Employee Health and Safety Orientation Checklist</p>
            <div class=" w-full justify-between items-center flex " >
                <p class=" text-2xl font-bold text-primary-text " >Free</p>
                <div class=" flex gap-2 items-center " >
                    <p class=" font-medium text-lg text-blue-bg " >Add Cart</p>
                </div>
            </div>
        </div>
    </div>
